// $ANTLR 3.4 ECMLFormula.g 2012-11-30 18:11:56
...
public class ECMLFormulaLexer extends Lexer {
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ECMLFormula.g:125:3: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // ECMLFormula.g:126:3: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            ...
            // ECMLFormula.g:131:3: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mFLOAT() throws RecognitionException {
        try {
            int _type = FLOAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ECMLFormula.g:147:3: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* )
            // ECMLFormula.g:148:3: ( '0' .. '9' )+ '.' ( '0' .. '9' )*
            {
            // ECMLFormula.g:148:3: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ECMLFormula.g:172:3: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // ECMLFormula.g:173:3: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // ECMLFormula.g:173:3: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt6=0;
            loop6:
    ...
    public void mTokens() throws RecognitionException {
        // ECMLFormula.g:1:8: ( T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | ID | INT | FLOAT | RELOP | ECMLOR | ECMLAND | SXOR | SXAND | OPER | WS )
        int alt7=23;
        alt7 = dfa7.predict(input);
        switch (alt7) {
            case 1 :
                // ECMLFormula.g:1:10: T__17
                {
                mT__17(); 
    ...
    class DFA7 extends DFA {
        ...
        public String getDescription() {
            return "1:1: Tokens : ( T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | ID | INT | FLOAT | RELOP | ECMLOR | ECMLAND | SXOR | SXAND | OPER | WS );";
        }
    }
