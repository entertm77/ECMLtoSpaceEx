// $ANTLR 3.4 SxNegTreeUnbound.g 2012-11-30 11:50:57
...
public class SxNegTreeUnbound extends TreeParser {
    ...
    public SxNegTreeUnbound(TreeNodeStream input) {
        this(input, new RecognizerSharedState());
    }
    public SxNegTreeUnbound(TreeNodeStream input, RecognizerSharedState state) {
        super(input, state);
    }
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String[] getTokenNames() { return SxNegTreeUnbound.tokenNames; }
    public String getGrammarFileName() { return "SxNegTreeUnbound.g"; }
    ...
    // $ANTLR start "and_exp"
    // SxNegTreeUnbound.g:19:1: and_exp : ( ^( SXAND and_exp rel_exp ) -> ^( SXOR and_exp rel_exp ) | rel_exp );
    public final SxNegTreeUnbound.and_exp_return and_exp() throws RecognitionException {
        SxNegTreeUnbound.and_exp_return retval = new SxNegTreeUnbound.and_exp_return();
        ...
        SxNegTreeUnbound.and_exp_return and_exp2 =null;

        SxNegTreeUnbound.rel_exp_return rel_exp3 =null;

        SxNegTreeUnbound.rel_exp_return rel_exp4 =null;
        ...
        try {
            // SxNegTreeUnbound.g:20:3: ( ^( SXAND and_exp rel_exp ) -> ^( SXOR and_exp rel_exp ) | rel_exp )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // SxNegTreeUnbound.g:21:3: ^( SXAND and_exp rel_exp )
                    {
                    ...
                    {
                        // SxNegTreeUnbound.g:21:31: ^( SXOR and_exp rel_exp )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // SxNegTreeUnbound.g:22:5: rel_exp
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "rel_exp"
    // SxNegTreeUnbound.g:25:1: rel_exp : ^(o= RELOP a= bi_exp b= bi_exp ) -> {$o.text.equals(\"==\")}? ^( SXOR ^( RELOP[\">\"] $a $b) ^( RELOP[\"<\"] $a $b) ) -> {$o.text.equals(\">=\")}? ^( RELOP[\"<\"] $a $b) -> {$o.text.equals(\"<=\")}? ^( RELOP[\">\"] $a $b) ->;
    public final SxNegTreeUnbound.rel_exp_return rel_exp() throws RecognitionException {
        SxNegTreeUnbound.rel_exp_return retval = new SxNegTreeUnbound.rel_exp_return();
        retval.start = input.LT(1);
        ...
        CommonTree o=null;
        SxNegTreeUnbound.bi_exp_return a =null;

        SxNegTreeUnbound.bi_exp_return b =null;
        ...
        try {
            // SxNegTreeUnbound.g:25:9: ( ^(o= RELOP a= bi_exp b= bi_exp ) -> {$o.text.equals(\"==\")}? ^( SXOR ^( RELOP[\">\"] $a $b) ^( RELOP[\"<\"] $a $b) ) -> {$o.text.equals(\">=\")}? ^( RELOP[\"<\"] $a $b) -> {$o.text.equals(\"<=\")}? ^( RELOP[\">\"] $a $b) ->)
            // SxNegTreeUnbound.g:26:4: ^(o= RELOP a= bi_exp b= bi_exp )
            {
            _last = (CommonTree)input.LT(1);
            {
            CommonTree _save_last_1 = _last;
            ...
            // AST REWRITE
            // elements: RELOP, b, RELOP, a, RELOP, a, a, RELOP, a, b, b, b
            // token labels: 
            ...
            if ((o!=null?o.getText():null).equals("==")) {
                // SxNegTreeUnbound.g:26:55: ^( SXOR ^( RELOP[\">\"] $a $b) ^( RELOP[\"<\"] $a $b) )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                (CommonTree)adaptor.create(SXOR, "SXOR")
                ...
                // SxNegTreeUnbound.g:26:62: ^( RELOP[\">\"] $a $b)
                {
                ...
                // SxNegTreeUnbound.g:26:82: ^( RELOP[\"<\"] $a $b)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                (CommonTree)adaptor.create(RELOP, "<")
            ...
            else // 27:9: -> {$o.text.equals(\">=\")}? ^( RELOP[\"<\"] $a $b)
            if ((o!=null?o.getText():null).equals(">=")) {
                // SxNegTreeUnbound.g:27:35: ^( RELOP[\"<\"] $a $b)
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                (CommonTree)adaptor.create(RELOP, "<")
            ...
            else // 28:9: -> {$o.text.equals(\"<=\")}? ^( RELOP[\">\"] $a $b)
            if ((o!=null?o.getText():null).equals("<=")) {
                // SxNegTreeUnbound.g:28:35: ^( RELOP[\">\"] $a $b)
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                (CommonTree)adaptor.create(RELOP, ">")
    ...
    // $ANTLR start "bi_exp"
    // SxNegTreeUnbound.g:31:1: bi_exp : ( ^(o= OPER a= primary_exp b= bi_exp ) | primary_exp );
    public final SxNegTreeUnbound.bi_exp_return bi_exp() throws RecognitionException {
        SxNegTreeUnbound.bi_exp_return retval = new SxNegTreeUnbound.bi_exp_return();
        retval.start = input.LT(1);
        ...
        CommonTree o=null;
        SxNegTreeUnbound.primary_exp_return a =null;

        SxNegTreeUnbound.bi_exp_return b =null;

        SxNegTreeUnbound.primary_exp_return primary_exp5 =null;


        CommonTree o_tree=null;

        try {
            // SxNegTreeUnbound.g:32:2: ( ^(o= OPER a= primary_exp b= bi_exp ) | primary_exp )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // SxNegTreeUnbound.g:32:2: ^(o= OPER a= primary_exp b= bi_exp )
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // SxNegTreeUnbound.g:33:2: primary_exp
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // SxNegTreeUnbound.g:36:1: primary_exp : ( ID | INT | FLOAT | '(' bi_exp ')' );
    public final SxNegTreeUnbound.primary_exp_return primary_exp() throws RecognitionException {
        SxNegTreeUnbound.primary_exp_return retval = new SxNegTreeUnbound.primary_exp_return();
        retval.start = input.LT(1);
        ...
        SxNegTreeUnbound.bi_exp_return bi_exp10 =null;
        ...
        try {
            // SxNegTreeUnbound.g:37:1: ( ID | INT | FLOAT | '(' bi_exp ')' )
            int alt3=4;
            switch ( input.LA(1) ) {
            case ID:
                {
            ...
            switch (alt3) {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // SxNegTreeUnbound.g:41:2: '(' bi_exp ')'
                    {
                    root_0 = (CommonTree)adaptor.nil();
